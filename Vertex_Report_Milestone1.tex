...
The following commits record the project's progress on the team repository
(\url{https://github.com/Moorani/xv6-distributed-inference}):
\begin{lstlisting}[language=,basicstyle=\ttfamily\footnotesize]
0fd36fc  Add Milestone 1 report (LaTeX source)
4d2aeb2  Add Mermaid figure source and rendered images (F1-F7, warmup)
9671353  Add gdb kernel trace on sys_exec
5c2523a  Add bring-up transcripts: single node, ring, weight-fetch
3c1cfe6  Add runbook; mark boot scripts executable; ignore build artifacts
